// components/evaluations/QualifyForm.tsx
// @ts-nocheck
...
const QualifyForm = ({
  ...
  // ✅ if it's rendered in the sheet, don't force SafeAreaView/StatusBar changes
  if (inSheet) {
    return <View className="flex-1 bg-white">{Body}</View>;
  }
